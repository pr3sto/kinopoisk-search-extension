...
<style lang="scss">
  ...
  #suggestions__loader {
    ...
    width: 100%;
    height: 100%;
    background: rgba($light-background-color, 0.4);
    z-index: 1;
  }
